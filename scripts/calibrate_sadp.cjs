...
console.log(JSON.stringify({snapshot:snapshot.retrievedAt,assumptions:{replacementFPoints:c.replacementFPoints,replacementD:c.replacementD,replacementG:c.replacementG,weights:{espnRank:.2,adp:.4,dom:.4},poolSize:pool.length,domRanksMatched:domByEspn.size},targetCounts:targets,neutral:evaluate(1,1),oldCorrections:evaluate(.86,.65,1.235),fittedLinear:best},null,2));
