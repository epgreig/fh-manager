...
function renderBoard_({c,players,state}) {
  ...
  ['F','D','G'].forEach((g,i)=>{
    ...
    ['Rk','ADP','DomRk'].forEach(h=>rankRanges.push(s.getRange(4,col+index[h],n,1)));
    smartRanges.push(s.getRange(4,col+index.sADP,n,1));panRanges.push(s.getRange(4,col+index.PAN,n,1));
