const DEFAULTS = {
  ...
  parTop:0.15, adpBottom:0.10, adpSigmaFloor:4, adpSigmaRate:0.18, espnRankWeight:0.5, multiplierF:1, multiplierD:0.81, multiplierG:0.77, panGap:22, highlightCount:12, youngAgeMax:23
};
